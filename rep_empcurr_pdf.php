...
$obj_pdf->SetTitle("Export current employees");  
...
<tr>
<th colspan="8" style="font-weight:Bold; border: 1px solid black;text-align:center;">Curent Employess report</th>
</tr>
<tr>
...
<th style="font-weight:bold; border: 1px solid black;">Date In</th>
</tr>
';

foreach($_SESSION['curr_emp'] as $row_emp) {
...
$html .='</table>';
        ...
        ob_end_clean();
		$obj_pdf->Output('current_employees.pdf', 'I');
