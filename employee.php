...
error_reporting(E_ALL);
	...
	if (isset($_POST['update'])){
		...
		//Update EMPLOYEE
		$sql_update = "UPDATE employee SET empl_number = '$empl_no', empl_name = '$empl_name', empl_dob = $empl_dob, empl_gender = $emplsex_id, empl_maritalStatus = '$emplmarried_id',
		 empl_position = '$empl_position', empl_salary = '$empl_salary', empl_address = '$empl_address',
		  empl_phone = '$empl_phone', empl_email = '$empl_email', empl_start = '$empl_in', empl_end = $empl_out, 
		  empl_lastupd = $timestamp, user_id = $_SESSION[log_id] WHERE empl_id = $_SESSION[empl_id]";
					...
					<?PHP
						...
						if (isset($result_empl['empl_pic']))
							echo '<img src="'.$result_empl['empl_pic'].'" title="Employee\'s picture">';
								...
								echo '<img src="ico/custpic_m.png" title="Upload new picture" alt="No image"/>';
						}
						echo '	</a>
										</td>
										<td>Empl. No:</td>
						...
						echo '<tr>
								...
								echo '</select>
									...
									<tr>
										...
										<td><input type="text" name="empl_maritalStatus" value="'.$result_empl['empl_maritalStatus'].'" placeholder="Marital status"/></td>
										<td>Employm. Start:</td>
