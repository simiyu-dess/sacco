...
error_reporting(E_ALL);
	...
	$savbalance = getSavingsBalance($db_link, $_SESSION['member_id']);

	//NEW LOAN-Button
	if (isset($_POST['newloan'])){

		//Calculate new Loan Number
		$sql_loanno = "SELECT loan_id FROM loans WHERE cust_id = '$_SESSION[member_id]'";
		...
		$sql_newloanid = "SELECT MAX(loan_id) FROM loans WHERE cust_id = '$_SESSION[member_id]'";
...
<html>
	...
	<body>
		...
		<div id="menu_main">
			...
			<a href="acc_sav_depos.php?cust=<?PHP echo $_SESSION['member_id'] ?>">Deposit</a>
			...
			<a href="loan_new.php?cust=<?PHP echo $_SESSION['member_id'] ?>" id="item_selected">New Loan</a>
